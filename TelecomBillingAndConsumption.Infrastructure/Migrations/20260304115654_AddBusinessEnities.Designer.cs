...
namespace TelecomBillingAndConsumption.Infrastructure.Migrations
{
    ...
    [Migration("20260304115654_AddBusinessEnities")]
    partial class AddBusinessEnities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TelecomBillingAndConsumption.Data.Entities.Bill", b =>
                {
                    ...
                    b.HasIndex("SubscriberId", "BillingMonth", "BillingYear")
                        .IsUnique();
            ...
            modelBuilder.Entity("TelecomBillingAndConsumption.Data.Entities.BillDetail", b =>
                {
                    ...
                    b.Property<decimal>("RoamingCharge")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TelecomBillingAndConsumption.Data.Entities.TariffRule", b =>
                {
                    ...
                    b.HasIndex("UsageType", "IsRoaming", "IsPeak", "EffectiveFrom");
